classdef FBMCphaseCondition < handle
    % =====================================================================        
    ...
    methods
        ...
        function obj = FBMCphaseCondition(varargin)
...
%             obj.Implementation.PhaseShift = exp(1j*pi/2*(l+k))*exp(1j*obj.Implementation.InitialPhaseShift);
            obj.Implementation.PhaseShift = exp(1j*pi/2*(l+k)).*exp(-1j*pi*(l.*k))*exp(1j*obj.Implementation.InitialPhaseShift);
