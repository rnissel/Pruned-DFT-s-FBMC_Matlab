classdef FBMC < handle
    ...
    methods
        ...
        function SetDependentParameters(obj)
            ...
            % Test prototype filter for DFT spread FBMC-OQAM           
                case 'HermiteCut-OQAM'                
                    obj.Implementation.TimeSpacing = obj.PHY.SamplingRate/(2*obj.PHY.SubcarrierSpacing);
                    obj.PHY.TimeSpacing =obj.Implementation.TimeSpacing*obj.PHY.dt;
                    obj.Implementation.FrequencySpacing = obj.PrototypeFilter.OverlappingFactor; 
                    PrototypeFilter = PrototypeFilter_Hermite(obj.PHY.TimeSpacing*2,obj.PHY.dt,2/2); % We use always overlappingfactor 2!!!!
%                     PrototypeFilter = PrototypeFilter-PrototypeFilter(1); 
                    PrototypeFilter(PrototypeFilter<0)=0; %!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!   
                    obj.PrototypeFilter.TimeDomain = zeros(obj.PrototypeFilter.OverlappingFactor*2*obj.Implementation.TimeSpacing,1);
                    obj.PrototypeFilter.TimeDomain(end/2+((-obj.Implementation.TimeSpacing*2+1):(obj.Implementation.TimeSpacing*2)))=PrototypeFilter;
                ...
                case 'Hann-OQAM'
                    ...
                    WindowLength = round(FFTSize*1.63/2)*2;
                    obj.PrototypeFilter.TimeDomain = zeros(obj.PrototypeFilter.OverlappingFactor*FFTSize,1);
                    obj.PrototypeFilter.TimeDomain(end/2+(-WindowLength/2:WindowLength/2-1))=hann(WindowLength);
                    obj.PrototypeFilter.TimeDomain = obj.PrototypeFilter.TimeDomain/sqrt(sum(abs(obj.PrototypeFilter.TimeDomain).^2)/obj.PHY.SamplingRate);
                    obj.Implementation.TimeSpacing = FFTSize/2;
                    obj.PHY.TimeSpacing =obj.Implementation.TimeSpacing*obj.PHY.dt;                    
                    obj.Implementation.FrequencySpacing = obj.PrototypeFilter.OverlappingFactor;       
                case 'Blackman-OQAM'
                    FFTSize = round(obj.PHY.SamplingRate/(obj.PHY.SubcarrierSpacing));     
                    WindowLength = round(FFTSize*1.72/2)*2;
                    obj.PrototypeFilter.TimeDomain = zeros(obj.PrototypeFilter.OverlappingFactor*FFTSize,1);  
                    obj.PrototypeFilter.TimeDomain(end/2+(-WindowLength/2:WindowLength/2-1))=blackman(WindowLength);
                    obj.PrototypeFilter.TimeDomain = obj.PrototypeFilter.TimeDomain/sqrt(sum(abs(obj.PrototypeFilter.TimeDomain).^2)/obj.PHY.SamplingRate);
                    obj.Implementation.TimeSpacing = FFTSize/2;
                    obj.PHY.TimeSpacing =obj.Implementation.TimeSpacing*obj.PHY.dt;                    
                    obj.Implementation.FrequencySpacing = obj.PrototypeFilter.OverlappingFactor;                        
                case 'PHYDYASCut-OQAM'
                    obj.Implementation.TimeSpacing = obj.PHY.SamplingRate/(2*obj.PHY.SubcarrierSpacing);
                    obj.PHY.TimeSpacing =obj.Implementation.TimeSpacing*obj.PHY.dt;
                    obj.Implementation.FrequencySpacing = obj.PrototypeFilter.OverlappingFactor;
                    PrototypeFilter = PrototypeFilter_PHYDYAS(obj.PHY.TimeSpacing*2,obj.PHY.dt,obj.PrototypeFilter.OverlappingFactor/2);
                    PrototypeFilter(PrototypeFilter<0)=0; %!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!   
                    obj.PrototypeFilter.TimeDomain = PrototypeFilter/sqrt(sum(abs(PrototypeFilter).^2)/obj.PHY.SamplingRate); 
                case 'InversePHYDYAS-OQAM'
                    obj.Implementation.TimeSpacing = obj.PHY.SamplingRate/(2*obj.PHY.SubcarrierSpacing);
                    obj.PHY.TimeSpacing =obj.Implementation.TimeSpacing*obj.PHY.dt;
                    obj.Implementation.FrequencySpacing = obj.PrototypeFilter.OverlappingFactor;
                    obj.PrototypeFilter.TimeDomain = PrototypeFilter_InversePHYDYAS(obj.PHY.TimeSpacing*2,obj.PHY.dt,obj.PrototypeFilter.OverlappingFactor/2);                
                case 'tRRC-OQAM'
                    obj.Implementation.TimeSpacing = obj.PHY.SamplingRate/(2*obj.PHY.SubcarrierSpacing);
                    obj.PHY.TimeSpacing =obj.Implementation.TimeSpacing*obj.PHY.dt;
                    obj.Implementation.FrequencySpacing = obj.PrototypeFilter.OverlappingFactor;                     
                    ...
                    obj.PrototypeFilter.TimeDomain = obj.PrototypeFilter.TimeDomain/sqrt(sum(abs(obj.PrototypeFilter.TimeDomain).^2)/obj.PHY.SamplingRate);                    
                case 'HermiteCut1.46-OQAM'
                    obj.Implementation.TimeSpacing = obj.PHY.SamplingRate/(2*obj.PHY.SubcarrierSpacing);
                    obj.PHY.TimeSpacing =obj.Implementation.TimeSpacing*obj.PHY.dt;
                    obj.Implementation.FrequencySpacing = obj.PrototypeFilter.OverlappingFactor; 
                    PrototypeFilter = PrototypeFilter_Hermite(obj.PHY.TimeSpacing*2,obj.PHY.dt,2/2); % We use always overlappingfactor 2!!!!                    
                    FFTSize = round(obj.PHY.SamplingRate/(obj.PHY.SubcarrierSpacing));    
                    PrototypeFilter_New = zeros(size(PrototypeFilter));   
                    O = 1.46;
                    PrototypeFilter_New(end/2+1+(-round(FFTSize/2*O):round(O*FFTSize/2)-1)) = PrototypeFilter(end/2+1+(-round(FFTSize/2*O):round(O*FFTSize/2)-1));                 
                    obj.PrototypeFilter.TimeDomain = zeros(obj.PrototypeFilter.OverlappingFactor*2*obj.Implementation.TimeSpacing,1);
                ...
                case 'HermiteCut0.8Tukey-OQAM'
                    ...
                    PrototypeFilter_New = zeros(size(PrototypeFilter));   
                    O = 0.8;
                    TukeyWindowFactor = 0.6;
                    PrototypeFilter_Temp = PrototypeFilter(end/2+1+(-round(FFTSize/2*O):round(O*FFTSize/2)-1));
                    PrototypeFilter_Temp = PrototypeFilter_Temp.*tukeywin(length(PrototypeFilter_Temp),TukeyWindowFactor);   
                    PrototypeFilter_New(end/2+1+(-round(FFTSize/2*O):round(O*FFTSize/2)-1)) = PrototypeFilter_Temp;                 
                    obj.PrototypeFilter.TimeDomain = zeros(obj.PrototypeFilter.OverlappingFactor*2*obj.Implementation.TimeSpacing,1);
                    obj.PrototypeFilter.TimeDomain(end/2+((-obj.Implementation.TimeSpacing*2+1):(obj.Implementation.TimeSpacing*2))) = PrototypeFilter_New;
                    obj.PrototypeFilter.TimeDomain = obj.PrototypeFilter.TimeDomain/sqrt(sum(abs(obj.PrototypeFilter.TimeDomain).^2)/obj.PHY.SamplingRate);
                case 'HermiteCut0.8-OQAM'
                     obj.Implementation.TimeSpacing = obj.PHY.SamplingRate/(2*obj.PHY.SubcarrierSpacing);
                    obj.PHY.TimeSpacing =obj.Implementation.TimeSpacing*obj.PHY.dt;
                    obj.Implementation.FrequencySpacing = obj.PrototypeFilter.OverlappingFactor; 
                    PrototypeFilter = PrototypeFilter_Hermite(obj.PHY.TimeSpacing*2,obj.PHY.dt,2/2); % We use always overlappingfactor 2!!!!                    
               ...
               case 'Chebwin-OQAM'
                    ...
                    O = 1.5;
                    PrototypeFilter_Temp = chebwin(FFTSize*O,80);
                    %PrototypeFilter_Temp([1 end])=0;
 
     
                    PrototypeFilter_New(end/2+1+(-floor(FFTSize/2*O):ceil(O*FFTSize/2)-1)) = PrototypeFilter_Temp;                 
                    obj.PrototypeFilter.TimeDomain = zeros(obj.PrototypeFilter.OverlappingFactor*2*obj.Implementation.TimeSpacing,1);
                    obj.PrototypeFilter.TimeDomain(end/2+((-obj.Implementation.TimeSpacing*2+1):(obj.Implementation.TimeSpacing*2))) = PrototypeFilter_New;
                    obj.PrototypeFilter.TimeDomain = obj.PrototypeFilter.TimeDomain/sqrt(sum(abs(obj.PrototypeFilter.TimeDomain).^2)/obj.PHY.SamplingRate);
...
function PrototypeFilter = PrototypeFilter_InversePHYDYAS(T0,dt,OF)
% The pulse is orthogonal for a time-spacing of T=T0 and a frequency-spacing of F=2/T0
t_filter=-(OF*T0):dt:(OF*T0-dt);

% p_TimeInversePHYDYAS_O3 = @(t,T0) (...
...
%      0.41143783 * sinc((2-3*t/T0*2)) ...    
%     )*sqrt(2/T0);
% PrototypeFilter = p_TimeInversePHYDYAS_O3(t_filter.',T0);

p_TimeInversePHYDYAS_O4 = @(t,T0) (...
     0.23514695 * sinc((3+4*t/T0*2)) + ...
     sqrt(2)/2  * sinc((2+4*t/T0*2)) + ...
     0.97195983 * sinc((1+4*t/T0*2)) + ...
     1 *          sinc((0+4*t/T0*2)) + ...
     0.97195983 * sinc((1-4*t/T0*2)) + ...
     sqrt(2)/2  * sinc((2-4*t/T0*2)) + ...
     0.23514695 * sinc((3-4*t/T0*2)) ...    
    )*sqrt(2/T0);
PrototypeFilter = p_TimeInversePHYDYAS_O4(t_filter.',T0);

% p_TimeInversePHYDYAS_O8 = @(t,T0) (...
...
%      0.03671221 * sinc((7-8*t/T0*2)) ...    
%     )*sqrt(2/T0);
% PrototypeFilter = p_TimeInversePHYDYAS_O8(t_filter.',T0);
